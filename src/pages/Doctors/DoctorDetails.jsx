        ...
        <div className="container px-2 py-[60px] sm:px-4 sm:pb-[100px] sm:pt-[60px] lg:px-[20px]">
          <div className="grid grid-cols-1 gap-[50px] lg:grid-cols-2 xl:grid-cols-3">
            <div className="col-span-2 xl:col-span-2">
              <div className="grid grid-flow-row grid-cols-1 items-start justify-start lg:grid-flow-col lg:grid-cols-3 lg:gap-5">
                <figure className="col-span-1 mb-8">
                  <img
                    src={doctorData[0].photo}
                    alt=""
            ...
            <div className="col-span-2 rounded-md border p-4 shadow-panelShadow lg:col-span-2 lg:p-5 xl:col-span-1">
